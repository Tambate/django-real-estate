    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Defaulte description..update me please...', verbose_name='Description')),
                ('country', django_countries.fields.CountryField(default='KE', max_length=2, verbose_name='Coutry')),
                ('city', models.CharField(default='Nariobi', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='140', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='KG8 EVENUA', max_length=150, verbose_name='Street Address')),
                ...
                ('advert_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Rent'), ('Auction', 'Auction')], default='For Sale', verbose_name='Advert Type')),
                ...
                ('pusblished_status', models.BooleanField(default=False, verbose_name='Published Status')),
