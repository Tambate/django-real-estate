...
class PropertyPushlishedManager(models.Manager):
    def get_queryset(self):

        return (
            super(PropertyPushlishedManager, self)
            .get_queryset()
...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        ...
        default="Defaulte description..update me please...",
    )
    country = CountryField(
        verbose_name=_("Coutry"),
        default="KE",
    ...
    pusblished_status = models.BooleanField(
    ...
    published = PropertyPushlishedManager()
    ...
    def save(self, *args, **kwargs):
        ...
        self.ref_code = "".join(
            random.choice(string.ascii_uppercase + str.digits, k=10)
        )
    ...
    def final_property_price(self):
        ...
        tax_ammount = round(tax_percentage * property_price, 2)
        price_after_tax = float(round(property_price + tax_ammount, 2))
